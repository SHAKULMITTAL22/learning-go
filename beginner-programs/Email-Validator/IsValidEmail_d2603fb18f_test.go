...
func TestIsValidEmail_d2603fb18f(t *testing.T) {
	...
	// Test case 5: Email address with valid TLD
	...
	// Test case 6: Email address with valid subdomain
	...
	// Test case 7: Email address with valid domain and subdomain
	email = "example@subdomain.example.co.uk"
	expected = true
	actual = IsValidEmail(email)
	if actual != expected {
		t.Errorf("Expected %t, got %t for email %s", expected, actual, email)
	...
	// Test case 8: Email address with valid domain and TLD
	email = "example@example.com.uk"
	expected = true
	actual = IsValidEmail(email)
	if actual != expected {
		t.Errorf("Expected %t, got %t for email %s", expected, actual, email)
	...
	// Test case 9: Email address with valid domain, subdomain and TLD
	email = "example@subdomain.example.com.uk"
	expected = true
	actual = IsValidEmail(email)
	if actual != expected {
		t.Errorf("Expected %t, got %t for email %s", expected, actual, email)
	...
	// Test case 10: Email address with valid domain, subdomain, TLD and ccTLD
	email = "example@subdomain.example.co.uk"
	expected = true
	actual = IsValidEmail(email)
	if actual != expected {
