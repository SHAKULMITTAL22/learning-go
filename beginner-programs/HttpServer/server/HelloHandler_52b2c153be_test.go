...
func TestHelloHandler_52b2c153be(t *testing.T) {
	...
	tests := []struct {
		...
		{"hello/John", "Valid name provided", "Hello, John"},
		{"", "Empty name provided", "Hello, world"}, //false test case
		{"hello/123", "Numeric name provided", "Hello, 123"},
		{"hello/<script>", "Special character provided", "Hello, &lt;script&gt;"}, //fasle test case generated
	}
