...
// Testlinearsearch376 tests the linearSearch function with various scenarios.
func Testlinearsearch376(t *testing.T) {
	testCases := []struct {
		name     string
		arr      []int
		query    int
	...
	for _, tc := range testCases {
		...
		t.Run(tc.name, func(t *testing.T) {
			t.Parallel() // Run tests in parallel for enhanced performance
