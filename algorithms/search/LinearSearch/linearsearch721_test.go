...
// Import the `linearSearch` function here
// import . "<appropriate package path>"

// Testlinearsearch721 tests the `linearSearch` function for various conditions
func Testlinearsearch721(t *testing.T) {
	tests := []struct {
		...
		// Scenario 4: Search for the First Element in a Multi-Element Array
		{
			name:     "First element in multi-element array",
			arr:      []int{3, 8, 12, 15},
			query:    3,
			expected: 0,
		},
		// Scenario 5: Search for the Last Element in a Multi-Element Array
		{
			name:     "Last element in multi-element array",
			arr:      []int{3, 8, 12, 15},
			query:    15,
			expected: 3,
		},
		...
		// Scenario 7: Search for a Duplicate Element
		{
			name:     "Duplicate elements in array",
			arr:      []int{3, 8, 12, 8, 15},
			query:    8,
			expected: 1,
		},
